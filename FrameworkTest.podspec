...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HevenHoo/FrameworkTest"
  ...
  s.source       = { :git => "https://github.com/HevenHoo/FrameworkTest.git", :tag => "#{s.version}" }
  ...
  s.vendored_frameworks = 'SimpleFramework.framework'
